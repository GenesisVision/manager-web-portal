...
import MetaTraderOrder from './MetaTraderOrder';
...
export default class TradesViewModel {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('trades')) {
                obj['trades'] = ApiClient.convertToType(data['trades'], [MetaTraderOrder]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:model/MetaTraderOrder>} trades
    */
    trades = undefined;
